            ...
            return (
              <motion.div 
                ...
                className={`rounded-xl border-2 transition-all duration-300 ${
                  isOpen ? 'border-indigo-600 shadow-md' : 'border-indigo-100'
                }`}
              >
                <button
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className={`font-semibold text-lg ${isOpen ? 'text-indigo-900' : 'text-slate-700'}`}>
                      {item.q}
                    </span>
                  </div>
                  ...
                  <div className="flex-shrink-0">
                    {isOpen ? (
                      <X className="h-6 w-6 text-indigo-600 transition-transform rotate-0" />
                    ) : (
                      <Plus className="h-6 w-6 text-indigo-400 transition-transform" />
                    )}
                  </div>
                </button>
                  ...
                  {isOpen && (
                    ...
                    >
                      <div className="px-14 pb-6">
                        ...
                        {item.cta && (
                          <button className="mt-4 bg-indigo-600 text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-indigo-700 transition-colors shadow-sm">
                            {item.cta}
                          </button>
                        )}
                      </div>
